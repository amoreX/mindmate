...
const moods = [
	...
	{
		name: "Sad",
		icon: <Smile className="h-6 w-6 rotate-180" />,
...
export default function MoodSelector({ setMood, curr }) {
				...
				<div className="grid grid-cols-5 gap-2">
					{moods.map((mood) => (
						<Button
							key={mood.name}
							variant="outline"
							className={`flex flex-col items-center justify-center h-20 ${mood.color} ${
